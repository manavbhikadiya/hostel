    ...
    <View style={{width, height}}>
      <View style={styles.container}>
        <ScrollView
          ...
          <ImageBackground
            source={require('../assets/darkForest.jpg')}
            resizeMode="cover"
          ...
          <View
            ...
            <View
              ...
              <Text style={{color: '#000033', fontWeight: 'bold'}}>
                Top Colleges
              </Text>
            </View>
                      ...
                      <View style={styles.cardView} key={index}>
                        <View>
                          <View style={{marginLeft: 20, marginTop: 20}}>
                            ...
                            <Text style={{fontSize: 12, color: '#F26161'}}>
                              From {hostel.college_name}
                            </Text>
                          </View>
                        </View>
                        <View
                        ...
                        <View style={{marginLeft: 20}}>
                          <Text
                            ...
                            {hostel.hostels[0].rooms_available} Rooms are left
                          </Text>
                          <View
                            style={{
                              position: 'absolute',
                        ...
                        <View style={{marginLeft: 20, marginTop: 20}}>
                          <TouchableOpacity
                            ...
                            <Text style={{color: '#000066', fontSize: 12}}>
                              View on map
                            </Text>
                          </TouchableOpacity>
                        </View>
                        <View
                          ...
                          <Text
                            ...
                            +91 {hostel.hostels[0].helpline_no}
                          </Text>
                        </View>
                      </View>
                    ) : null}
