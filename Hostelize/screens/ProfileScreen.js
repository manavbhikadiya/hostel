...
const ProfileScreen = ({ navigation }) => {
  ...
  const getUserData = () => {
    ...
    axios.get(`https://hosteldashboards.herokuapp.com/user/getUserData/${userId}`)
      .then((res) => {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.profileImageContainer}>
          {
            initialData ? (<View style={styles.profileImage}>
              <Image source={{ uri: profileImage }} style={styles.profile_image} />
            </View>) : (
              <View style={styles.profileImage}>
                <Image source={require('../assets/profile_1.jpeg')} style={styles.profile_image} />
              </View>
            )
          }
        </View>
        {
          isDataLoading ? (<ActivityIndicator color="#000066" size={40} />)
            :
            (
